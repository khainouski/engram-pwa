...
const PATHS = {
  ...
  repeat: '<path d="M4.2 11.2a7.8 7.8 0 0 1 13.4-5.4l2.2 2.2"/><path d="M20.2 4.2v3.8h-3.8"/><path d="M19.8 12.8a7.8 7.8 0 0 1-13.4 5.4l-2.2-2.2"/><path d="M3.8 19.8V16h3.8"/>',
  sound: '<path d="M11 5.2 6.8 8.6H4.2a1 1 0 0 0-1 1v4.8a1 1 0 0 0 1 1h2.6L11 18.8z"/><path d="M15.4 9.4a3.6 3.6 0 0 1 0 5.2"/><path d="M18.2 6.8a7.2 7.2 0 0 1 0 10.4"/>',
  search: '<circle cx="11" cy="11" r="6.6"/><path d="m16 16 4.4 4.4"/>',

  // Install flow
  install: '<path d="M12 3.8v9.4"/><path d="m8.2 9.6 3.8 3.8 3.8-3.8"/><path d="M4.5 16.4v2a1.7 1.7 0 0 0 1.7 1.7h11.6a1.7 1.7 0 0 0 1.7-1.7v-2"/>',
  share: '<path d="M12 3.6v11"/><path d="m8.4 7.2 3.6-3.6 3.6 3.6"/><path d="M6.6 10.4H5.4a1.7 1.7 0 0 0-1.7 1.7v6.6a1.7 1.7 0 0 0 1.7 1.7h13.2a1.7 1.7 0 0 0 1.7-1.7v-6.6a1.7 1.7 0 0 0-1.7-1.7h-1.2"/>',
  'add-to-home': '<rect x="4" y="4" width="16" height="16" rx="3.4"/><path d="M12 8.8v6.4"/><path d="M8.8 12h6.4"/>',
